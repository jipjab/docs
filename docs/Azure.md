...
![Disable Security Defaults in Portal Azure AD](img/AzureAD-disable-security-defaults.png)

> Microsoft Entra ID > Identity > Overview > Properties

![Disable Security Defaults in Microsoft Entra ID](img/EntraID-disable-security-defaults.png)
...
![Protect Against MFA Fatigue](img/protect-mfa-fatigue.png)
...
![Self-service password reset](img/user-password-self-reset.png)
...
![Custom banned passwords](img/custom-banned-passwords.png)
...
![password protection is enabled for on-prem Active Directory](img/password_protection%20_on-prem_AD.png)
...
![Password hash sync](img/password-hash-sync.png)
...
![Sign-in risk policies](img/sign-in-risky.png)
...
![Stay Connected](img/stay-connected.png)
...
![Restrict access to the Azure AD administration portal](img/interdire-users-aad-portal.png)
